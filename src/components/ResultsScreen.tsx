      ...
      <div className="bg-slate-900/60 px-8 pt-8 pb-6 border-b border-slate-700/50">
        ...
        <motion.div variants={fadeUp} initial="initial" animate="animate">
          <div className="flex items-end gap-3 mb-3">
            ...
            <span className="text-2xl font-light text-slate-500 mb-2">
              / {total}
            </span>
          </div>
          <div
            className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border text-xs font-semibold bg-slate-700/50 border-slate-700/50`}
          >
            <span className="text-slate-500">accuracy: {percent}%</span>
          </div>
        </motion.div>
      </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-slate-300 text-xs leading-snug mb-2 font-medium">
                      {q.question}
                    </p>
